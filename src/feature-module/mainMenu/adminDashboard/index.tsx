          ...
          <>
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
              <div className="my-auto mb-2">
                <h3 className="page-title mb-1">Dashboard Administrateur</h3>
                <nav>
                  <ol className="breadcrumb mb-0">
                    <li className="breadcrumb-item">
                      <Link to={routes.adminDashboard}>Dashboard</Link>
                    </li>
                    <li className="breadcrumb-item actifs" aria-current="page">
                ...
                <div className="alert-message">
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <p>
                        Alpha Sylla a payé les frais pour le
                        <strong className="mx-1">"Semestre 2023"</strong>
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-xl-center justify-content-xl-between flex-xl-row flex-column">
                      <div className="mb-3 mb-xl-0">
                        ...
                        <p className="text-white">Bonne journée au travail</p>
                      </div>
                      <p className="text-white custom-text-white">
                        <i className="ti ti-refresh me-1" />
                        Mis à jour récemment le 15 juin 2024
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-xxl-4 col-xl-6 col-md-12 d-flex">
                <div className="card flex-fill">
                  <div className="card-header d-flex align-items-center justify-content-between">
                    <div>
                      <h4 className="card-title">Emploi du temps</h4>
                    </div>
                    <Link
                      to="#"
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="tab-content">
                      <div className="tab-pane fade actifs show" id="students">
